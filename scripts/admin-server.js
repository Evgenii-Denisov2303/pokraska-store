...
function getSecurityHeaders(pathname) {
    ...
    const publicFrameSrc = "frame-src 'self' https://forms.yandex.ru https://yandex.ru https://*.yandex.ru";
    const csp = isAdmin
        ...
        : `default-src 'none'; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; connect-src 'self'; font-src 'self'; manifest-src 'self'; ${publicFrameSrc}; frame-ancestors 'self'; base-uri 'self'; form-action 'self'`;
