...
Дальше на самой странице появится кнопка `Редактировать на странице`.
...
- заказчик открывает нужную страницу сайта как обычный посетитель
- если логин включен, он нажимает кнопку входа прямо на странице
- после входа он нажимает `Редактировать на странице` и работает там же
